...
while(input_command != "stop"):
   ...
   if input_command != "stop":
       if len(input_command) != 5 | len(input_command) != 9:
           ...
           if ord(product_id1[0]) >= 65 & ord(product_id1[0]) <= 89:
               if ord(product_id1[1]) >= 49 & ord(product_id1[1]) <= 53:
                   if ord(product_id1[2]) >= 48 & ord(product_id1[2]) <= 57:
                       if ord(product_id1[3]) >= 48 & ord(product_id1[3]) <= 57:
                           if order == str('0'):
                           ...
                           if order == str('9'):
                               if len(input_command) == 9:
                                   if ord(product_id2[0]) >= 65 & ord(product_id2[0]) <= 89:
                                       if ord(product_id2[1]) >= 49 & ord(product_id2[1]) <= 53:
                                           if ord(product_id2[2]) >= 48 & ord(product_id2[2]) <= 57:
                                               if ord(product_id2[3]) >= 48 & ord(product_id2[3]) <= 57:
