...
def showdataAll():
   ...
   wh4.stateData()
   wh5.stateData()
def getInfo():return wh1.getInfo(), wh2.getInfo(), wh3.getInfo(), wh4.getInfo(), wh5.getInfo()
class Robot:
   def __init__(self):
   ...
   def manuallmove(self, id_product1, id_product2):
       ...
       if self.rehash_key[id_product1] == "Belt":
           return print("now product " + id_product1 + " is on belt")
...
while(input_command != "stop"):
   ...
   if input_command != "stop":
       if (len(input_command) == 5) or (len(input_command) == 9):
           ...
           if input_command == str('40000'):
               getInfo()
           if input_command == str('60000'):
               print(r.rehash_key)
           if input_command == str('70000'):
               showdataAll()
           if order == str('0'):
